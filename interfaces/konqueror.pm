...
#
# PLEASE REMEMBER TO EDIT THAT NOT (ie|mozilla|konqueror).pm FILE
# OK!
...
<link rel="stylesheet" href="$config->{script_login}?interface=konqueror&item=style" />
</head>
...
<input type="text" class="form-say" name="say" autocomplete="off"  size="100">
</form>
